...
const Footer = () => {
  ...
  return (
    <div
      id="Footer"
      className="bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-900 text-white py-16 pt-24 md:pt-28 px-6 md:px-16 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          >
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-3 rounded-full">
              <FaRegPaperPlane size={30} className="text-white" />
            </div>
          </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gradient-to-b from-white/5 to-white/[0.02] backdrop-blur-sm p-6 md:p-8 rounded-xl border border-white/10 shadow-xl hover:shadow-indigo-500/10 transition-shadow duration-300"
          >
            <h2 className="text-2xl font-bold mb-6 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">Send a Message</h2>
            
            {formStatus.isSubmitted ? (
              <motion.div 
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 p-6 rounded-lg flex flex-col items-center justify-center gap-4 text-indigo-200"
              >
                <div className="bg-gradient-to-r from-indigo-500 to-purple-500 p-3 rounded-full">
                  <MdDone size={24} className="text-white" />
                </div>
                <span className="text-lg font-medium">Thank you for your message!</span>
                <p className="text-center text-gray-400">I'll get back to you as soon as possible.</p>
              </motion.div>
            ) : (
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                {formStatus.error && (
                  <motion.div 
                    ...
                    className="bg-red-500/20 p-4 rounded-lg text-red-300 text-sm"
                  >
                    {formStatus.error}
                  </motion.div>
                )}
                ...
                <div className="group">
                  <label htmlFor="name" className="block text-sm font-medium text-gray-300 mb-1 group-focus-within:text-indigo-300 transition-colors">
                    Name
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-4 py-3 bg-white/5 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white transition-all duration-300"
                    placeholder="Your name"
                  />
                </div>
                
                <div className="group">
                  <label htmlFor="email" className="block text-sm font-medium text-gray-300 mb-1 group-focus-within:text-indigo-300 transition-colors">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="group">
                  <label htmlFor="message" className="block text-sm font-medium text-gray-300 mb-1 group-focus-within:text-indigo-300 transition-colors">
                    Message
                  </label>
                  <textarea
                    id="message"
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 shadow-xl transition-all duration-300 hover:shadow-indigo-500/10 hover:border-indigo-500/30">
              <h2 className="text-2xl font-bold mb-6 text-indigo-300 flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 flex items-center justify-center">
                  <MdOutlineEmail size={18} className="text-white" />
                </div>
                Contact Info
              </h2>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 shadow-xl transition-all duration-300 hover:shadow-indigo-500/10 hover:border-indigo-500/30">
              ...
              <motion.div 
                className="mt-4 p-3 rounded-lg bg-gradient-to-r from-indigo-900/30 to-purple-900/30 border border-indigo-500/20 relative overflow-hidden"
                whileHover={{ scale: 1.02 }}
              >
                ...
                <p className="text-right text-xs text-gray-400 mt-2">- Tim Berners-Lee</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-3 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">Skills & Technologies</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">Here are some of the technologies I work with</p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {[
              ...
              <motion.div
                key={index}
                className="bg-white/5 backdrop-blur-sm py-2 px-4 rounded-full border border-white/10 flex items-center gap-2"
                whileHover={{ 
                  scale: 1.05, 
                ...
                viewport={{ once: true }}
              >
                <div className={`w-8 h-8 rounded-full bg-gradient-to-r ${skill.color} flex items-center justify-center`}>
                  {skill.icon}
                </div>
        ...
        {/* Animated divider */}
        <div className="relative h-12 my-12">
          <motion.div 
        ...
        <div className="mt-8 pt-8 border-t border-white/10 text-center">
          <div className="flex justify-center gap-4 mb-4">
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.9 }}
            >
              <CiLinkedin className="text-gray-300" size={20} />
            </motion.a>
            <motion.a 
              ...
              whileTap={{ scale: 0.9 }}
            >
              <MdOutlineEmail className="text-gray-300" size={20} />
            </motion.a>
          </div>
          <motion.p 
